...
| Current | 🚨 **`uidValidityResetPendingAt` STAYS ARMED ON PURPOSE — NEVER DEMAND PROOF OF TRANSIENCE** — every abort leg leaves the re-drive flag SET; discharge via "a refusal writes nothing" + `crawlWalkWriteAllowed` was the LAST consumer writing under an armed flag (`16ecafd93`) | [read in full](Companion/Memory/Current/112-uidvalidityresetpendingat-is-a-redrive-flag-that-stays-armed-on-purpose.md) |
