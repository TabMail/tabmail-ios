...
@Suite("SyncEngine.selfHealBackfillFTSMembership — orphan detection + re-index", .serialized, .processGlobalState)
...
@Suite("SyncEngine.pruneFTSOrphans — dead FTS entry removal", .serialized, .processGlobalState)
