...
struct HTTPRequestResult: Sendable {
    ...
    /// Carries the body **whole** — never truncated. The 500-character cap a
    /// few lines below applies only to the human-readable log line, never to
    /// what a classifier receives.
