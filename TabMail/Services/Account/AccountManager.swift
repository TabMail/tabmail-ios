...
actor AccountManager {
    ...
    /// One execution/settlement owner for this manager's queue lifetime.
    let operationExecutor = AccountOperationExecutor()
    ...
    /// change removes.
    ///
    /// BOUNDED and SHORT-LIVED exactly like the executor’s retained settlement above — the one
