...
/// Preview: `InboxChatPillTip` on the DynamicIslandChat pill at bottom of `InboxView`.
#Preview("InboxChatPillTip — InboxView") {
    let scenario = PreviewMocks.seedInbox()
    PreviewMocks.spotlight(InboxChatPillTip.self)
