...
> **⚠️ SUPERSEDED / HISTORICAL as of v1.7.0 (2026-08-07). The problem described below is FIXED.**
>
> **The `**Status:** Current` line in the preserved body is STALE, and so is its precedence claim.**
> That line says *"where the index and this file differ, **this file wins**"*. That is now **REVERSED**:
> `CLAUDE.md` is normative and wins over this file. The body is preserved unedited because its bytes
> are pinned by `Companion/Memory/amendments-manifest.tsv`; read this note in its place.
>
> It is kept because the reasoning is still the best account of *why* the design landed where it did,
> and because compaction never deletes superseded material. **Do not read it as live state.**
>
